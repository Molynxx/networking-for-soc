# Networking for SOC/Blue Team

Praktyczne podstawy sieci komputerowych z perspektywy analityka SOC i Detection Engineering.

## Cel
Zrozumienie protokołów sieciowych, analizy ruchu i wykrywania zagrożeń w kontekście Security Operations Center.

## Struktura 
- `00_network_fundamentals` - fundamenty sieci (model OSI, adresacja, porty),
